...
export const w18Extra = {
  ...
  '18-1': [
    ...
    },
    {
      ...
      testCases: [
        { input: 'group_orders([("A", "x"), ("B", "y"), ("A", "z")])' },
        { input: 'group_orders([("C", "item1")])' },
        { input: 'group_orders([])' },
      ],
  ...
  '18-4': [
    {
      ...
      testCases: [
        { input: 'flatten_dict({"a": {"b": 1, "c": {"d": 2}}, "e": 3})' },
        { input: 'flatten_dict({"x": 1})' },
        { input: 'flatten_dict({})' },
      ],
  ...
  '18-5': [
    {
      ...
      testCases: [
        { input: 'p = Product("Laptop", 999.99, 5)\np.total_value()' },
        { input: 'p = Product("Mouse", 29.99)\np.total_value()' },
        { input: 'Product("A", 10.0, 3) == Product("A", 10.0, 3)' },
      ],
