  ...
  '18-1': [
    {
      ...
      testCases: [
        { input: 'top_keywords(["Great battery life", "Battery is amazing", "great screen"], 2)' },
        { input: 'top_keywords(["hello world", "hello"], 1)' },
        { input: 'top_keywords(["a b c", "d e f"], 3)' },
      ],
    ...
    },
    {
      ...
      testCases: [
        { input: 'group_orders([("Electronics", "Phone"), ("Clothing", "T-shirt"), ("Electronics", "Earbuds"), ("Clothing", "Jacket")])' },
        { input: 'group_orders([("Food", "Apple")])' },
        { input: 'group_orders([])' },
      ],
  ...
  '18-3': [
    {
      ...
      testCases: [
        { input: 'import os, tempfile\ntf = tempfile.NamedTemporaryFile(mode="w", suffix=".csv", delete=False)\ntf.write("order_id,amount,category\\n1,250.5,Electronics\\n2,89.9,Clothing\\n3,1200.0,Electronics\\n")\ntf.close()\nresult = sum_column(tf.name, "amount")\nos.unlink(tf.name)\nresult' },
      ],
  ...
  '18-4': [
    {
      ...
      testCases: [
        { input: 'flatten_dict({"user": {"name": "Alice", "address": {"city": "Taipei", "zip": "100"}}, "active": True})' },
        { input: 'flatten_dict({"a": 1, "b": 2})' },
        { input: 'flatten_dict({"x": {"y": {"z": 42}}})' },
      ],
    ...
    },
    {
      ...
      testCases: [
        { input: 'safe_get({"data": {"weather": {"temp": 25.5}}}, ["data", "weather", "temp"])' },
        { input: 'safe_get({"data": {"weather": {"temp": 25.5}}}, ["data", "wind", "speed"])' },
        { input: 'safe_get({"data": {"weather": {"temp": 25.5}}}, ["data", "wind", "speed"], 0)' },
        { input: 'safe_get({}, ["a", "b"], "missing")' },
      ],
  ...
  '18-5': [
    {
      ...
      testCases: [
        { input: 'p = Product("Laptop", 999.99, 3)\np.total_value()' },
        { input: 'p = Product("Mouse", 29.99)\np.total_value()' },
        { input: 'p1 = Product("A", 10.0, 1)\np2 = Product("A", 10.0, 1)\np1 == p2' },
      ],
